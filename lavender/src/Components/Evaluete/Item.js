...
export default function Item(props) {
  ...
  useEffect(() => {
    customerApi
      .findCustomerByCustomerId(props.evaluete.makhachhang)
      .then((success) => {
      ...
      <div className="item-review__box-review">
          ...
          <div className="box-info">
            <div className="box-info__avatar">
              <img
                alt="avatar"
                src={
                  khachhang === undefined || khachhang.image===undefined || khachhang.image === ""
                    ? logopink
                    : (khachhang.image === "/khachhang"
                    ? imageApi.image(khachhang.image, khachhang.makhachhang)
                    : khachhang.image
                    )
                }
              ></img>
        ...
        <div className="box-review__box-question">
          <div className="raiting">
            ...
            <i
              className={
                props.evaluete.sosao < 1 ? "fas fa-star" : "fas fa-star checked"
              }
            />
            <i
              className={
                props.evaluete.sosao < 2 ? "fas fa-star" : "fas fa-star checked"
              }
            />
            <i
              className={
                props.evaluete.sosao < 3 ? "fas fa-star" : "fas fa-star checked"
              }
            />
            <i
              className={
                props.evaluete.sosao < 4 ? "fas fa-star" : "fas fa-star checked"
              }
            />
            <i
              className={
                props.evaluete.sosao < 5 ? "fas fa-star" : "fas fa-star checked"
              }
            />
          </div>
          ...
          <div className="review-comment__images">
            <img
              ...
              alt="anhbinhluan"
              src={imageApi.image(
                props.evaluete.image,
                props.evaluete.madanhgia
              )}
            ></img>
          </div>
        </div>
