...
function Register(props) {
  ...
  const handleSubmit = () => {
    ...
    bodyFormData.append("ngaysinh", new Date(ngaysinh).toISOString().split("T")[0]);
                  ...
                  <form className="mx-1 mx-md-6">
                    <div className="d-flex flex-row align-items-center mb-4">
                      ...
                      <div className="form-outline flex-fill mb-0">
                        <input type="text" id="name" className="form-control border"
                        value = {hovaten}
                    ...
                    <i class="fas fa-phone fa-lg me-3 fa-fw"></i>
                      <div className="form-outline flex-fill mb-0">
                        <input type="tel" id="tel" className="form-control border"
                    ...
                    <div className="d-flex flex-row align-items-center mb-4">
                      ...
                      <div className="form-outline flex-fill mb-0">
                        <input type="date" id="birth" className="form-control border" 
                    ...
                    <div className="form-check d-flex justify-content-center mb-5">
                      ...
                      <label className="form-check-label" htmlFor="confirm">
                        Đồng ý với tất cả các tuyên bố trong <Link to = "/rules">Các điều khoản dịch vụ</Link>
                      </label>
                    </div>
                  </form>
                </div>
