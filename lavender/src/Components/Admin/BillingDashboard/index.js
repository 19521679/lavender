              ...
              <div className="row">
                <div className="container pt-4">
                  <div className="d-flex align-items-center cards1">
                    ...
                    <div className="card1">
                      <div className="mb-3"> <span className="text-grey fs-5">Thống kê</span></div>
                      <div className="mt-auto">
                        <div className="d-flex align-items-center">
                          <div className="profile"> <img src="https://icons.iconarchive.com/icons/graphicloads/polygon/256/stats-icon.png" alt="" /> </div>
                          <div className="ms-2">
                    ...
                    <div className="card1">
                      <div className="mb-3"> <span className="text-grey fs-5">Tổng tiền phiếu nhập</span></div>
                      <div className="mt-auto">
                        <div className="d-flex align-items-center">
                          <div className="profile"> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRm7rWFV6QE1SKhM51OPN7FzUJTTA7oPLCQVSnadkGJMM-i9uHTM0Ltr-Tipjq-GuV8Yms&usqp=CAU" alt="" /> </div>
                          <div className="ms-2">
        ...
        <div className="upper">
          <div className="card9 bg-dark">
            <div className="details">
              <div className="d-flex flex-column card-details"> <span className="plus">Platinum Plus</span>
                <h4 className="amount">$54454.90</h4>
              </div> <img src="https://i.imgur.com/ZnvAG93.png" width={40} className="coral" />
            </div>
            <div className="d-flex justify-content-between mt-3 align-items-center card-number"> <img src="https://i.imgur.com/xTeZOlU.png" width={30} />
              <div className="d-flex flex-column number"> <span>**** **** 9899</span> <span className="text-right">11/33</span> </div>
            </div>
          </div>
        </div>
