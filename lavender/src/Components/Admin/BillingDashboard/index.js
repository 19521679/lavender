                    ...
                    <div className="card5-outer">
                      <div className="card5">
                        ...
                        <div className="card5-details">
                          <div className="card5-number">
                            {" "}
                            <span>4800</span> <span>4800</span>{" "}
                            <span>4800</span> <span>4800</span>{" "}
                          </div>
                          <div className="date">
                            {" "}
                        ...
                        <div className="ownername">
                          ...
                          <img alt="" src="https://imgur.com/KpIC2Cs.png" />{" "}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="container p-2">
                    <div className="card4">
                      <div className="name text-left mb-3">
                        ...
                        <img
                          alt=""
                          src="https://i.imgur.com/5ld43yc.png"
                          width={100}
                        />{" "}
                      </div>
                      <div className="cardnumber d-flex justify-content-between align-items-center px-3 mb-3">
                        {" "}
                        <span>4535</span> <span>9898</span> <span>4234</span>{" "}
                        <span>5566</span>{" "}
                      </div>
                      <div className="text-right visa">
                        {" "}
                        <img
                          alt=""
                          src="https://i.imgur.com/HW3MltH.png"
                          width={80}
                        />{" "}
                      </div>
                    </div>
                    ...
                    <li className="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                        ...
                        <div>
                          <div className="">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                this.setState({
                                  tungay1: new Date(e.target.value),
                                })
                              }
                              value={
                                this.state.tungay1.toISOString().split("T")[0]
                              }
                            ></input>
                          </div>
                        </div>
                        <div>
                          <div className="">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                this.setState({
                                  denngay1: new Date(e.target.value),
                                })
                              }
                              value={
                                this.state.denngay1.toISOString().split("T")[0]
                              }
                            ></input>
                          </div>
                        </div>
                      ...
                      <div className="d-flex align-items-center text-sm">
                        <button
                          ...
                          id="fileban"
                          onClick={this.xuatFileHoadon.bind(this)}
                        >
                          <h1>
                    ...
                    <li className="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                        ...
                        <div>
                          <div className="">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                this.setState({
                                  tungay2: new Date(e.target.value),
                                })
                              }
                              value={
                                this.state.tungay2.toISOString().split("T")[0]
                              }
                            ></input>
                          </div>
                        </div>
                        <div>
                          <div className="">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                this.setState({
                                  denngay2: new Date(e.target.value),
                                })
                              }
                              value={
                                this.state.denngay2.toISOString().split("T")[0]
                              }
                            ></input>
                          </div>
                        </div>
                      ...
                      <div className="d-flex align-items-center text-sm">
                        <button
                          className="btn btn-link text-dark display-1"
                          id="filenhap"
                          onClick={this.xuatFilePhieunhap.bind(this)}
                        >
                          <h1>
                            <i class="bi bi-file-earmark-excel"></i>
                          </h1>
