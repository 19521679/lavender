...
export default class Home extends Component {
  ...
  renderList() {
    ...
    for (var i = 0; i < this.state.data.length; i++) {
      result.push(
        <ProductItem key={i} product={this.state.data[i]}></ProductItem>
      );
    }
    return result;
  }
    ...
    await mobileApi
      ...
      .then((success) => {
        if (success.status === 200) {
          this.setState({ data: success.data.value.$values, loading: false });
        }
      })
      .catch((error) => {
        console.log(error);
      ...
      <section className="container section-home">
          ...
          <div className="box-title">
            ...
            <div className="box-related-tag">
              <div className="list-related-tag">
                <Link to="/mobile/apple" className="btn btn-default btn-sm">
                  Apple
                </Link>
                <Link to="/mobile/samsung" className="btn btn-default btn-sm">
                  Samsung
                </Link>
                <Link to="/mobile/xiaomi" className="btn btn-default btn-sm">
                  Xiaomi
                </Link>
                <Link to="/mobile/oppo" className="btn btn-default btn-sm">
                  OPPO
                </Link>
                <Link to="/mobile/realme" className="btn btn-default btn-sm">
                  Realme
                </Link>
                <Link to="/mobile/nokia" className="btn btn-default btn-sm">
                  Nokia
                </Link>
                <Link to="/mobile/vivo" className="btn btn-default btn-sm">
                  Vivo
                </Link>
        ...
        <div className="row">
          <div className=" box-title">
            ...
            <div className="box-related-tag">
              <div className="list-related-tag">
                <Link to="/laptop/mac" className="btn btn-default btn-sm">
                  Mac
                </Link>
                <Link to="/laptop/asus" className="btn btn-default btn-sm">
                  ASUS
                </Link>
                <Link to="/laptop/hp" className="btn btn-default btn-sm">
                  HP
                </Link>
                <Link to="/laptop/surface" className="btn btn-default btn-sm">
                  Surface
                </Link>
                <Link to="/laptop/msi" className="btn btn-default btn-sm">
                  MSI
                </Link>
                <Link to="/laptop/dell" className="btn btn-default btn-sm">
                  Dell
                </Link>
        ...
        <div className="highlight section-bg laptopnoibat">
          <div className="container list-item2 " data-aos="fade-up">
            <div className="row row-item"></div>
          </div>
        </div>
