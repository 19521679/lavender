  ...
  render() {
    return (
      <section className="container section-home">
        ...
        <Link to="/lavender/promotion" className="row promotion4 ">
        ...
        <div className="row">
          <div className="box-title">
            <Link to="/lavender/mobile" className="box-title__title">
              <h2>Điện thoại nổi bật nhất</h2>
            </Link>
            <div className="box-related-tag">
              <div className="list-related-tag">
                <Link
                  to="/lavender/mobile?hang=apple"
                  className="btn btn-default btn-sm"
                >
                  Apple
                </Link>
                <Link
                  to="/lavender/mobile?hang=samsung"
                  className="btn btn-default btn-sm"
                >
                  Samsung
                </Link>
                <Link
                  to="/lavender/mobile?hang=xiaomi"
                  className="btn btn-default btn-sm"
                >
                  Xiaomi
                </Link>
                <Link
                  to="/lavender/mobile?hang=oppo"
                  className="btn btn-default btn-sm"
                >
                  OPPO
                </Link>
                <Link
                  to="/lavender/mobile?hang=realme"
                  className="btn btn-default btn-sm"
                >
                  Realme
                </Link>
                <Link
                  to="/lavender/mobile?hang=nokia"
                  className="btn btn-default btn-sm"
                >
                  Nokia
                </Link>
                <Link
                  to="/lavender/mobile?hang=vivo"
                  className="btn btn-default btn-sm"
                >
                  Vivo
                </Link>
                <Link to="/lavender/mobile" className="item-related-tag">
                  Xem tất cả
                </Link>
              </div>
            </div>
        ...
        <div className="row">
          <div className=" box-title">
            <Link to="/lavender/laptop" className="box-title__title">
              <h2>Laptop</h2>
            </Link>
            <div className="box-related-tag">
              <div className="list-related-tag">
                <Link
                  to="/lavender/laptop?hang=mac"
                  className="btn btn-default btn-sm"
                >
                  Mac
                </Link>
                <Link
                  to="/lavender/laptop?hang=asus"
                  className="btn btn-default btn-sm"
                >
                  ASUS
                </Link>
                <Link
                  to="/lavender/laptop?hang=hp"
                  className="btn btn-default btn-sm"
                >
                  HP
                </Link>
                <Link
                  to="/lavender/laptop?hang=surface"
                  className="btn btn-default btn-sm"
                >
                  Surface
                </Link>
                <Link
                  to="/lavender/laptop?hang=msi"
                  className="btn btn-default btn-sm"
                >
                  MSI
                </Link>
                <Link
                  to="/lavender/laptop?hang=dell"
                  className="btn btn-default btn-sm"
                >
                  Dell
                </Link>
                <Link to="/lavender/laptop" className="item-related-tag">
                  Xem tất cả
                </Link>
              </div>
            </div>
                ...
                <div className="brand-items">
                  <div className="brch-row">
                    <div className="brand-item">
                      <Link to="/lavender/mobile?hang=samsung">
                        <img
                    ...
                    <div className="brand-item">
                      <Link to="/lavender/mobile?hang=apple">
                        <img
                    ...
                    <div className="brand-item">
                      <Link to="/lavender/mobile?hang=xiaomi">
                        <img
                    ...
                    <div className="brand-item">
                      <Link to="/lavender/mobile?hang=oppo">
                        <img
                    ...
                    <div className="brand-item">
                      <Link to="/lavender/mobile?hang=realme">
                        <img
                    ...
                    <div className="brand-item">
                      <Link to="/lavender/mobile?hang=nokia">
                        <img
                    ...
                    <div className="brand-item">
                      <Link to="/lavender/mobile?hang=vivo">
                        <img
                    ...
                    <div className="brand-item">
                      <Link to="/lavender/mobile?hang=vsmart">
                        <img
                  ...
                  <div className="brch-row">
                    <div className="brand-item">
                      <Link to="/lavender/laptop?hang=asus">
                        <img
                    ...
                    <div className="brand-item">
                      <Link to="/lavender/laptop?hang=lg">
                        <img
                    ...
                    <div className="brand-item">
                      <Link to="/lavender/laptop?hang=acer">
                        <img
                    ...
                    <div className="brand-item">
                      <Link to="/lavender/laptop?hang=hp">
                        <img
                    ...
                    <div className="brand-item">
                      <Link to="/lavender/laptop?hang=dell">
                        <img
                    ...
                    <div className="brand-item">
                      <Link to="/lavender/laptop?hang=microsoft">
                        <img
                    ...
                    <div className="brand-item">
                      <Link to="/lavender/laptop?hang=msi">
                        <img
                    ...
                    <div className="brand-item">
                      <Link to="/lavender/laptop?hang=lenovo">
                        <img
