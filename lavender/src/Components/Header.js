        ...
        <div className="container d-flex align-items-center justify-content-between">
          ...
          <div id="navbar" className="navbar">
            <ul>
              {showMenu(menus)}
              <li>
                <Link className="getstarted scrollto button-to-cart" to="/cart">
                <i className="fas fa-shopping-cart icon-getstarted" style={{fontSize:"17px"}}></i>
                  GIỎ HÀNG
                </Link>
              </li>
              {this.props.makhachhang !== undefined && (
                <li>
                  <Link className="getstarted scrollto button-to-cart" to="/lmember">
                    <svg
              ...
              {this.props.manhanvien !== undefined && (
                <li>
                  <Link className="getstarted scrollto button-to-cart" to="/admin/overview">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
              ...
              {this.props.makhachhang === undefined &&
                this.props.manhanvien === undefined &&
                  (
                    <li>
                      <Link className="getstarted scrollto button-to-cart" to="/login">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                          height="16"
