...
export default function Caythongnoel() {
  return (
    <div>
      <div>
        <svg
  ...
  C0,2.6,1.56,4,2,4s2-1.4,2-2.9C4,0.49,3.51,0,2.9,0z"
            ...
            >
              ...
              <stop
                offset="0.1"
                style={{ stopColor: "#0867C7", stopOpacity: "0.6" }}
              />
              <stop
                offset={1}
                style={{ stopColor: "#081029", stopOpacity: 0 }}
              />
            </radialGradient>
            <mask id="treePathMask">
              <path
                className="treePathMask"
                fill="none"
                strokeWidth={18}
                stroke="#FFF"
